        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-green-600 block mt-2">WhatsApp Solutions</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Transform your customer engagement with our advanced WhatsApp automation.
              Generate quality leads, streamline communication, and boost your B2B
              presence in Dubai.
            </p>
            ...
            <div className="mt-8 flex items-center gap-8">
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600">5.0 (150+ reviews)</span>
                </div>
              </div>
            </div>
          </div>
